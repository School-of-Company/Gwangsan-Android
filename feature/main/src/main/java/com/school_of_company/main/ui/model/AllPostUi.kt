package com.school_of_company.main.ui.model
...
data class AllPostUi(
    ...
    val type: String,
    val mode: String,
    val member: AllMemberUi,
    val images: PersistentList<AllImageUi>,
)

@Stable
data class AllMemberUi(
    val memberId: Long,
    val nickname: String,
